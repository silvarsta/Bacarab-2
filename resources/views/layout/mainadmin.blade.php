            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw ms-2">Bacarab</span>
                    </a>
                </div>
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item {{ 'admin/dashboard' == request()->path() ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ 'admin/question' == request()->path() ? 'active' : '' }}">
                        <a href="{{ route('admin.question') }}" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">User Question</div>
                        </a>
                    </li>
                </ul>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('assets/img/admin/icon-admin.png') }}" alt
