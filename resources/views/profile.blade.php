...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            <h1 class="bacarab me-auto text-info"><a href="/main" style="text-decoration: none; color: #47b2e4;">BACARAB</a></h1>
                ...
                <ul>
                    ...
                    <li>
                        <a href="#" class="nav-link scrollto active" style="display: flex; align-items: center;">
                            <div class="profile-img"> <img src="{{ asset('assets/img/icon/user-icon.png') }}" alt="User-prifile"> </div>
            ...
            <div class="profile-nav col-md-3">
                <div class="panel">
                    <div class="user-heading round">
                        <a href="#"> <img src="{{ asset('assets/img/icon/user-icon2.png') }}" alt=""> </a>
                        <h1 class="my-4"><strong>{{ Auth::user()->name }}</strong></h1>
                        <p style="margin-bottom: 70px;font-size: 14px; ">{{ Auth::user()->email }}</p>
                    </div>
                </div>
                <div class="log-out mt-5"> <a href="{{ route('logout') }}"><button class="btn btn1"><strong>Log Out</strong> </button></a> </div>
                <div class="log-out">
                    <form action="{{ route('delete-account') }}" method="post">
                        @csrf
                        <button class="btndel btn2" type="submit" onclick="return confirm('Apakah Anda yakin ingin menghapus akun ini?')"><strong>Delete Account</strong> </button>
                    </form>
                </div>
            </div>
    ...
    <footer>
        <div class="container footer-bottom clearfix"
            style="position: absolute; bottom: 20px; width: 80%; margin-left: 100px;">
            <div class="copyright">
